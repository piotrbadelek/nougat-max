...
client.on('guildCreate', serw => { // kiedyś z tego wyraz wyjdzie, na razie mamy "er"" XD   ja to moge zrobic   ok                               ok                           ok
  ...
  client.user.setActivity(`_help | ${client.guilds.cache.size} serwerów! | Wersja Dev-Build1 Unstable Krzesło`, { type: "WATCHING" });// evala będzie o wiele łatwiej
})
...
client.on("ready", () => {
  ...
  client.user.setActivity(`_help | ${client.guilds.cache.size} serwerów! | Wersja Dev-Build1 Unstable Krzesło | Coverage: ${commandCount}/93`, { type: "WATCHING" });
});
