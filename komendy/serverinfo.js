...
class xd {
  ...
  async run (client, msg, args) {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .addField("Członkowie | Ludzie | Boty", `${msg.guild.members.size} | ${msg.guild.members.filter(member => !member.user.bot).size} | ${msg.guild.members.filter(member => member.user.bot).size}`, true)
        .addField("Level weryfikacji", verifLevels[msg.guild.verificationLevel], true)
        .addField("Kanały", msg.guild.channels.size, true)
        .addField("Role", msg.guild.roles.size, true)
