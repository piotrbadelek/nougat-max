                ...
                if (oznaczony == false) {
                    ...
                    try {
                        ...
                        let embedd = new Discord.MessageEmbed()
                            ...
                            .addField("Wysyłasz SMSa do użytkownika:", client.users.cache.get(idpozwanego).tag)
                    ...
                    if (m.content.toLowerCase().includes("tak")) {
                        ...
                        setAuthor("Orange", "https://logoeps.com/wp-content/uploads/2011/06/orange-logo-vector.png")
                            ...
                            .setDescription("Pozywam użytkownika " + client.users.cache.get(idpozwanego).tag + " za " + powodpozwania + "...");
                        msg.channel.send(nowyembed)
                        collector.stop()
                        const mybed = new Discord.MessageEmbed()
                        .setColor((Math.random() * 0xFFFFFF << 0).toString(16))
                        ...
                        .setDescription("Otrzymałeś wiadomość! :mailbox_with_mail: \Wiadomość od użytkownika <@" + msg.author.id + ">. Treść: " + powodpozwania);
                        client.users.cache.get(idpozwanego).send(mybed) // same wysyłanie dma do pozwanego, jak potrzeba to zmienić na embeda czy cokolwiek
